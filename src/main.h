...
static const int64_t COIN_YEAR_REWARD = 77.7 * CENT; // 77.7% per year
static const int64_t COIN_YEAR_REWARD2 = 10 * CENT; //10%
static const int MODIFIER_INTERVAL_SWITCH = 18;

inline bool IsProtocolVCurrent(int nHeight) { return TestNet() || nHeight > 24; }

inline int64_t FutureDriftVusually(int64_t nTime) { return nTime + 4 * 60; }
inline int64_t FutureDriftVCurrent(int64_t nTime) { return nTime + 15; }
